    ...
    <Popover.Root>
      <Popover.Trigger asChild>
        {sessionData.user.image ? (
          <Image
            className="cursor-pointer rounded-full outline-none outline-offset-2 transition-all hover:outline hover:outline-gray-200 focus:shadow-[0_0_0_2px] focus:shadow-black"
          ...
          <div
            className="h-10 w-10 cursor-pointer items-center justify-center self-center rounded-full bg-red-400 outline-none outline-offset-2 transition-all hover:outline hover:outline-gray-200 focus:shadow-[0_0_0_2px] focus:shadow-black"

...
export default function Linkbud() {
  ...
  return (
    <>
      ...
      <main className="min-h-screen w-full bg-teal-700">
        <div className="flex flex-col items-center justify-start gap-2 bg-teal-700 px-8 py-20 text-white sm:mx-auto sm:w-96">
          <img
